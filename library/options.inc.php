...
function generate_form_field($frow, $currvalue) {
  ...
  //VicarePlus :: A single selection list with ability to add it for  Race and Ethnicity
        ...
        if (!$got_selected && strlen($currvalue) > 0)
        {
        //While upgrading If there is no matching value from list check the ethrace list
         $list_id='ethrace';
